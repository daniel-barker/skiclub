...
import { units as mockUnits } from "../../mockData/unitsMock";
  ...
  const deleteHandler = async (id) => {
    if (window.confirm("Are you sure you want to delete this member unit?")) {
      try {
        ...
        await handleFormSuccess("Member unit deleted successfully");
      } catch (err) {
        toast.error("Error deleting member unit");
      }
    }
  };
...
export default MockMemberListScreen;
