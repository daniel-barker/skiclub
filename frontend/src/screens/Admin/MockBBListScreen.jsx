...
import { posts as mockPosts } from "../../mockData/postsMock";
...
const MockBBListScreen = () => {
  // Prepare posts with status field
  ...
  const deleteHandler = async (id) => {
    if (window.confirm("Are you sure you want to delete this post?")) {
      try {
        ...
        await handleFormSuccess("Post deleted successfully");
      } catch (err) {
...
export default MockBBListScreen;
