...
import { users } from "../../mockData/usersMock";
  ...
  const deleteHandler = async (id) => {
    if (window.confirm("Are you sure you want to delete this user?")) {
      try {
        ...
        setMockUsers(mockUsers.filter(user => user._id !== id));
        await handleFormSuccess("User deleted successfully");
      } catch (err) {
...
export default MockUserListScreen;
